...
const Footer = () => {
  return (
    ...
    >
      <div className="flex justify-center pt-6 pb-6 sm:pt-5 sm:pb-5 flex-col sm:flex-row dark:text-white">
        <h5 className="text-sm text-light text-center sm:text-base sm:mb-0 ">
          Raaz Dura 2024.
          View the code{" "}
          <a
